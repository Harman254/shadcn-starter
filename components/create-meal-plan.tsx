...
const CreateMealPlan = ({ preferences, isOnboardComplete }: CreateMealPlanProps) => {
  ...
  return (
    <div
      ...
      className="relative min-h-screen w-full bg-white dark:bg-[#030303]"
    >
      ...
      <div className="w-full max-w-7xl mx-auto py-4 sm:py-6 md:py-8 lg:py-12 px-3 sm:px-4 md:px-6 lg:px-8 space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
        {/* Hero Section */}
        <div className="text-center space-y-4 sm:space-y-6">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-50 to-lime-50 dark:from-emerald-950/50 dark:to-teal-950/50 border border-green-200/50 dark:border-emerald-800/50 text-green-700 dark:text-emerald-300 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium shadow-sm">
            <Utensils className="h-3 w-3 sm:h-4 sm:w-4" />
            AI-Powered Nutrition Planning
          </div>

          <div className="space-y-3 sm:space-y-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-slate-100 leading-tight">
              Create Your Perfect
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-green-100 dark:bg-amber-900/50 flex items-center justify-center">
                      <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-amber-400" />
                    </div>
                    <div>
                      <p className="font-semibold text-sm sm:text-base text-green-900 dark:text-amber-100">Free Plan Active</p>
                      <p className="text-xs sm:text-sm text-green-700 dark:text-amber-300">
                        {generationCount}/{maxGenerations} generations used this week
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-xl sm:text-2xl font-bold text-green-600 dark:text-amber-400">
            ...
            <Card className="border-green-200/60 dark:border-emerald-800/60 bg-gradient-to-r from-green-50 via-lime-50 to-green-50 dark:from-emerald-950/30 dark:via-teal-950/30 dark:to-emerald-950/30 shadow-sm">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-center gap-3">
                  <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-green-100 dark:bg-emerald-900/50 flex items-center justify-center">
                    <Crown className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-emerald-400" />
                  </div>
                  <div className="text-center">
                    <p className="font-semibold text-sm sm:text-base text-green-900 dark:text-emerald-100">Pro Plan Active</p>
                    <p className="text-xs sm:text-sm text-green-700 dark:text-emerald-300">Unlimited meal plan generations</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <Card className="border-0 shadow-2xl shadow-slate-200/20 dark:shadow-slate-900/40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
          <CardHeader className="bg-gradient-to-r from-slate-50/80 via-white/80 to-slate-50/80 dark:from-slate-800/80 dark:via-slate-900/80 dark:to-slate-800/80 border-b border-slate-200/50 dark:border-slate-700/50 p-4 sm:p-6 md:p-8">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-2xl bg-gradient-to-br from-[#08e605] to-green-600 flex items-center justify-center shadow-lg shadow-emerald-500/25">
              ...
              <div>
                ...
                <CardDescription className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mt-1">
          ...
          <CardContent className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              {/* Duration Selector */}
              <div className="space-y-3 sm:space-y-4">
                <Label className="text-sm sm:text-base font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                  <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-green-600" />
                  Plan Duration
                </Label>
                <Select value={duration.toString()} onValueChange={(v) => setDuration(Number.parseInt(v))}>
                  <SelectTrigger className="h-12 sm:h-14 text-sm sm:text-base border-slate-200 dark:border-slate-700 hover:border-green-300 dark:hover:border-green-600 transition-all duration-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    {[
                      ...
                      <SelectItem key={option.value} value={option.value.toString()} className="py-2 sm:py-3">
                        <div className="flex items-center justify-between w-full">
                          ...
                          <span className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">{option.subtitle}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="space-y-3 sm:space-y-4">
                <Label className="text-sm sm:text-base font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                  <ChefHat className="h-4 w-4 sm:h-5 sm:w-5 text-green-600" />
                  Daily Meals
                </Label>
                    ...
                    {[
                      ...
                      <SelectItem key={option.value} value={option.value.toString()} className="py-2 sm:py-3">
                        <div className="flex items-center justify-between w-full">
                          ...
                          <span className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 ml-3">{option.subtitle}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
            ...
            {/* Plan Summary */}
            <div className="bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-800/50 dark:via-slate-900/50 dark:to-slate-800/50 rounded-2xl p-4 sm:p-6 md:p-8 border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-slate-100 mb-4 sm:mb-6 flex items-center gap-3">
                <div className="h-6 w-6 sm:h-8 sm:w-8 rounded-xl bg-gradient-to-br from-[#08e605] to-green-600 flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                <div className="text-center p-4 sm:p-6 bg-white/60 dark:bg-slate-800/60 rounded-xl border border-slate-200/50 dark:border-slate-700/50">
                  <div className="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mb-2">{duration}</div>
                  <div className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400">Days</div>
                </div>
                <div className="text-center p-4 sm:p-6 bg-white/60 dark:bg-slate-800/60 rounded-xl border border-slate-200/50 dark:border-slate-700/50">
                  <div className="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mb-2">{totalMeals}</div>
                  <div className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400">Total Meals</div>
                </div>
                <div className="text-center p-4 sm:p-6 bg-white/60 dark:bg-slate-800/60 rounded-xl border border-slate-200/50 dark:border-slate-700/50">
                  <div className="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mb-2">~{estimatedTime}h</div>
                  <div className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400">Prep Time</div>
                </div>
              </div>
