      ...
      {hasMealPlan && mealPlan ? (
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <button onClick={() => router.push('/meal-plans')} className="px-8 py-4 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors flex items-center gap-2">
