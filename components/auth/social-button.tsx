...
const SocialButton: React.FC<SocialButtonProps> = ({
  ...
  return (
    <Button
      ...
      className={`w-full font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center focus:outline-none focus:ring-4 ${bgStyles[provider]}`}
    >
      {svgIcons[provider]}
      {label}
    </Button>
