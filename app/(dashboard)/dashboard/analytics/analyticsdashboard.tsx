    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {account?.isPro ? (
          ...
          <Card className="mb-8 border-0 bg-gradient-to-r from-amber-400 via-orange-400 to-yellow-400 text-white shadow-xl">
            <CardContent className="p-6">
        ...
        {/* Motivational Message */}
        <Card className="mb-8 border-0 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-l-4 border-l-green-500">
          <CardContent className="p-6">
